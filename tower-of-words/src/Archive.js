          ...
          <div className="super-inner-left">
            ...
            <ul style={{listStyle: 'none'}}>
                    {words.map((word, index) => (
                        <li key={index} >
                            <div className={word.id !== selected.id ? "the-default": "the-selected"} onClick={() => {toSelect(word)}}>{word.theword}</div>
                        </li>
                    ))}
          ...
          <div className="super-inner-right">
            {Object.keys(selected).length > 0 ?
                    <div className="word-info-container">
                      ...
                      <div className="pronounciation">{selected.prounounciation}<button><img src='./images/audio_orange.png'/></button></div>
